...
public class TestCandidate8
{
    ...
    public static void deleteByLoc(ArrayList<Candidate> candidate, int position)
    {
        candidate.remove(position);
    }
    
    public static void deleteByName(ArrayList<Candidate> candidate, String findName)
    {
        int position = 0;
        int i;
