...
public class CandyTester
{
    public static void main(String [] args) throws IOException
    {
        ...
        //Student adds a statement to invoke the candyColor method to assign colors to an array
        
        candy.readFile();
        
        //Student adds a statement to invoke the colorFrequency method to calculate the percentage of each color
        
        candy.printTotals(); //modify this method to print a frequency table showing colors, cumulative numbers, and percentages
    } 
}
